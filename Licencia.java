...
public class Licencia extends JFrame implements ActionListener, ChangeListener{
  ...
  public Licencia(){
    ...
    textarea1.setText("\n\n          TÉRMINOS Y CONDICIONES" +
                    "\n\n            A.  PROHIBIDA SU VENTA O DISTRIBUCIÓN SIN AUTORIZACIÓN DE LA LIBRERIA." +
                    "\n            B.  PROHIBIDA LA ALTERACIÓN DEL CÓDIGO FUENTE O DISEÑO DE." +
                    "\n            C.  Prohibido alterar las condiciones del libro." +
                    "\n            D. Devolver el libro en el tiempo previsto" +
                    "\n\n        Si el usuario no se encuentra de acuerdo con los Términos y condiciones" +
                    "\n          generales de uso, se le solicita que no haga uso, ni acceda a la información" + 
