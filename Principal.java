...
public class Principal extends JFrame implements ActionListener{
    ...
    public Principal() {
      ...
      getContentPane().setBackground(new Color(92,157,164));
      ...
      mb = new JMenuBar();
      mb.setBackground(new Color(204,52,103));
      setJMenuBar(mb);

      menuOpciones = new JMenu("Opciones");
      menuOpciones.setBackground(new Color(204,52,103));
      menuOpciones.setFont(new Font("Andale Mono", 1, 14));
      menuOpciones.setForeground(new Color(255, 255, 255));
      mb.add(menuOpciones);

      menuCalcular = new JMenu("Calcular");
      menuCalcular.setBackground(new Color(204,52,103));
      menuCalcular.setFont(new Font("Andale Mono", 1, 14));
      menuCalcular.setForeground(new Color(255, 255, 255));
      mb.add(menuCalcular);

      menuAcercaDe = new JMenu("Acerca de");
      menuAcercaDe.setBackground(new Color(204,52,103));
      ...
      menuColorFondo.setForeground(new Color(204,52,103));
      menuOpciones.add(menuColorFondo);

      miCalculo = new JMenuItem("Total");
      miCalculo.setFont(new Font("Andale Mono", 1, 14));
      miCalculo.setForeground(new Color(204,52,103));
      menuCalcular.add(miCalculo);
      miCalculo.addActionListener(this);

      miRojo = new JMenuItem("Rojo");
      miRojo.setFont(new Font("Andale Mono", 1, 14));
      miRojo.setForeground(new Color(204,52,103));
      menuColorFondo.add(miRojo);
      miRojo.addActionListener(this);

      miNegro = new JMenuItem("Negro");
      miNegro.setFont(new Font("Andale Mono", 1, 14));
      miNegro.setForeground(new Color(204,52,103));
      menuColorFondo.add(miNegro);
      miNegro.addActionListener(this);

      miMorado = new JMenuItem("Morado");
      miMorado.setFont(new Font("Andale Mono", 1, 14));
      miMorado.setForeground(new Color(204,52,103));
      menuColorFondo.add(miMorado);
      miMorado.addActionListener(this);

      miNuevo = new JMenuItem("Nuevo");
      miNuevo.setFont(new Font("Andale Mono", 1, 14));
      miNuevo.setForeground(new Color(204,52,103));
      menuOpciones.add(miNuevo);
      miNuevo.addActionListener(this);

      miElCreador = new JMenuItem("El creador");
      miElCreador.setFont(new Font("Andale Mono", 1, 14));
      miElCreador.setForeground(new Color(204,52,103));
      menuAcercaDe.add(miElCreador);
      miElCreador.addActionListener(this);

      miSalir = new JMenuItem("Salir");
      miSalir.setFont(new Font("Andale Mono", 1, 14));
      miSalir.setForeground(new Color(204,52,103));
      ...
      labelTitle = new JLabel("Calculador de la cantidad de prestamo del Libro");
      ...
      labelAPaterno = new JLabel("Nombre del Libro:");
      ...
      labelAMaterno = new JLabel("Codigo del Libro:");
      ...
      labelDepartamento = new JLabel("Selecciona la Editorial:");
      ...
      comboDepartamento.addItem("Library of America");
      comboDepartamento.addItem("Editoral MACRO E.I.R.L");
      comboDepartamento.addItem("Grandes Libros");

      labelAntiguedad = new JLabel("Tiempo del prestamo:");
      ...
      comboAntiguedad.addItem("9 meses a más de prestamo");
      ...
      textarea1.setText("\n   Aquí aparece la cantidad que debe del libro prestado.");
	    ...
	    String Antiguedad = comboAntiguedad.getSelectedItem().toString();
            ...
            if(nombreTrabajador.equals("") || AP.equals("") || AM.equals("") ||
               Departamento.equals("") || Antiguedad.equals("")){
                ...
                if(Departamento.equals("Library of America")){

                                if(Antiguedad.equals("1 a 3 meses de prestamo")){
					textarea1.setText("\n   El Usuario " + nombreTrabajador + " que debe del libro" + AP + 
                                                          "\n   de codigo" + AM + ", editorial " + Departamento +  
                                                          "\n   con un tiempo de prestamo " + Antiguedad + " DEBE: 4 soles ");
				}
				if(Antiguedad.equals("4 a 8 meses de prestamo")){
					textarea1.setText("\n   El Usuario " + nombreTrabajador + " que debe del libro" + AP + 
                                                          "\n   de codigo" + AM + ", editorial " + Departamento +  
                                                          "\n   con un tiempo de prestamo " + Antiguedad + " DEBE: 9 soles ");
				}
				if(Antiguedad.equals("9 meses a más de prestamo")){
					textarea1.setText("\n   El Usuario " + nombreTrabajador + " que debe del libro" + AP + 
                                                          "\n   de codigo" + AM + ", editorial " + Departamento +  
	        ...
	        if(Departamento.equals("Editoral MACRO E.I.R.L")){

				if(Antiguedad.equals("1 a 3 meses de prestamo")){
					textarea1.setText("\n   El Usuario " + nombreTrabajador + " que debe del libro" + AP + 
                                                          "\n   de codigo " + AM + ", editorial " + Departamento +  
                                                          "\n   con un tiempo de prestamo " + Antiguedad + " DEBE: 3 soles ");
				}
				if(Antiguedad.equals("4 a 8 meses de prestamo")){
					textarea1.setText("\n   El Usuario " + nombreTrabajador + " que debe del libro" + AP + 
                                                          "\n   de codigo " + AM + ", editorial " + Departamento +  
	    	...
	    	if(Departamento.equals("Grandes Libros")){

				if(Antiguedad.equals("1 a 3 meses de prestamo")){
					textarea1.setText("\n   El Usuario " + nombreTrabajador + " que debe del libro" + AP + 
                                                          "\n   de codigo " + AM + ", editorial " + Departamento +  
                                                          "\n   con un tiempo de prestamo " + Antiguedad + " DEBE: 5 soles ");
				}
				if(Antiguedad.equals("4 a 8 meses de prestamo")){
					textarea1.setText("\n   El Usuario " + nombreTrabajador + " que debe del libro" + AP + 
                                                          "\n   de codigo " + AM + ", editorial " + Departamento +  
	...
	if (e.getSource() == miMorado){
            getContentPane().setBackground(new Color(164,92,143));
        }
	...
	if (e.getSource() == miSalir){
        ...
        if (e.getSource() == miElCreador){
            ...
            JOptionPane.showMessageDialog(null,"Desarrollado por KSK Company\n"+
                                               "    www.youtube.com/k&s");
        }
    }
